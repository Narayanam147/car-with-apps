    ...
    var Joystick = (
      ...
      function(_super) {
        ...
        function Joystick2(props) {
          ...
          _this._pointerMove = function(event) {
            ...
            if (_this.state.dragging) {
              ...
              var bounded = (0, shape_bounds_factory_1.shapeBoundsFactory)(
                //@ts-ignore
                _this.props.controlPlaneShape || _this.props.baseShape,
                absoluteX,
                absoluteY,
                relativeX,
                relativeY,
          ...
          _this._throttleMoveCallback = /* @__PURE__ */ function() {
            var lastCall = 0;
        ...
        Joystick2.prototype.render = function() {
          ...
          return React.createElement(
            "div",
            { "data-testid": "joystick-base", className: this.props.disabled ? "joystick-base-disabled" : "", ref: this._baseRef, style: baseStyle },
